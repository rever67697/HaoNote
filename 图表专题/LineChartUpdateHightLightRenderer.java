...
public class LineChartUpdateHightLightRenderer extends LineRadarRendererTwo {
    ...
    public LineChartUpdateHightLightRenderer(LineDataProvider chart, ChartAnimator animator,
    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
                ...
                //                LinearGradient lg = new LinearGradient(0,0,mLineBuffer.length, 0, dataSet.getColor(0), dataSet.getColor(1), Shader.TileMode.MIRROR);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            // draw the higthLigntLines
            drawHighlightLines(c, (float) pix.x, (float) pix.y, set, mR, mWidth);
