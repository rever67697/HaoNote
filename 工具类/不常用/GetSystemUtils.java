...
public class GetSystemUtils {
	...
	public static String getSysSdk() {
	    ...
	    LogMessageUtils.i("GetSystemUtils-->>getSysLanguage", sdkVersion);
	    return sdkVersion;
	}
	...
	public static String getSysLanguage() {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysLanguage",  language);
		return language;
	}
	...
	public static String getSysModel() {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysModel",  model);
		return model;
	}
	...
	public static String getSysRelease() {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysRelease",  release);
		return release;
	}
	...
	public static String getSysSIMSerialNum(Context content) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysSIMSerialNum",  simSerialNumber);
    ...
    public static String getSysCPUSerialNum() {
        ...
        try {
            ...
            e.printStackTrace();
            LogMessageUtils.e("GetSystemUtils-->>getSysCPUSerialNum",  e.getMessage().toString());
        }
        	return cpuSerialNum;
    }
	...
	private static TelephonyManager getSysTelephonyManager(Context content) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysTelephonyManager",  telephonyManager + "");
	...
	public static String getSysTelephoneSerialNum(Context content) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysTelephoneSerialNum",  deviceId + "");
		return deviceId;
	}
	...
	public static String getSysCarrier(Context content) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysCarrier",  moblieType);
		return moblieType;
	}
	...
	public static Integer getSysPhoneState(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysPhoneState",  callState + "");
		return callState;
	}
	...
	public static CellLocation getSysPhoneLoaction(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysPhoneLoaction",  cellLocation + "");
		return cellLocation;
	}
	...
	public static String getSysDeviceSoftVersion(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysDeviceSoftVersion",  deviceSoftwareVersion + "");
	...
	public static String getSysPhoneNumber(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysPhoneNumber",  phoneNumber + "");
		return phoneNumber;
	}
	...
	public static String getSysSimCode(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysSimCode",  code + "");
		return code;
	}
	...
	public static String getSysSimPrivatorName(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysSimPrivatorName",  simOperatorName);
	...
	public static String getSysUserPhoneId(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysUserPhoneId",  subscriberId);
		return subscriberId;
	}
	...
	public static DisplayMetrics getSysDisplayMetrics(Activity activity) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysDisplayMetrics",  "获取屏幕管理对象为：" + displayMetrics);
	...
	public static int[] getScreenDispaly(Context context) {
		...
		LogMessageUtils.i("GetSystemUtils-->>getScreenDispaly-->>width",  "获取屏幕宽度为：" + width);
		LogMessageUtils.i("GetSystemUtils-->>getScreenDispaly-->>height",  "获取屏幕高度为：" + height);
    ...
    public static Integer getSysScreenWidth(Context context) {  
        ...
        LogMessageUtils.i("GetSystemUtils-->>getSysScreenWidth",  "获取屏幕宽度为：" + displayMetrics.widthPixels);
    ...
    public static Integer getSysScreenHeight(Context context)  {  
        ...
        DisplayMetrics displayMetrics = new DisplayMetrics();  
        wm.getDefaultDisplay().getMetrics(displayMetrics);  
        LogMessageUtils.i("GetSystemUtils-->>getSysScreenHeight",  "获取屏幕高度为：" + displayMetrics.heightPixels);
    ...
    public static Integer getSysScreenStatusHeight(Context context)  {  
        ...
        try {  
            ...
            LogMessageUtils.i("GetSystemUtils-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度为：" + statusHeight);
        } catch (Exception e) {  
            e.printStackTrace();  
            LogMessageUtils.e("GetSystemUtils-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度失败！" + e.getMessage());
        }  
        	return statusHeight;  
    } 
	...
	public static Integer getSysDefaultThreadPoolSize() {
		...
		LogMessageUtils.i("GetSystemUtils-->>getSysDefaultThreadPoolSize",  availableProcessors + "");
    ...
    public static Integer getSysSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {  
        ...
        LogMessageUtils.i("GetSystemUtils-->>getSysSampleSize",  roundedSize + "");
        return roundedSize;  
    }  
    ...
    public String getSysLocalIpAddress() {
        ...
        try {
        	...
        	e.printStackTrace();
        	LogMessageUtils.e("GetSystemUtils-->>getSysLocalIpAddress",  e.getMessage().toString());
        }
        	LogMessageUtils.i("GetSystemUtils-->>getSysLocalIpAddress",  hostAddress);
        	return hostAddress;
    }
